...
export const projectInfo: ProjectModel[] = [
    { 
        ...
        description: "This project is a static website which I built myself using in order to show my skills, interests, and projects. " +
        ...
        "webpage without any sort of template I took my time designing each piece of the page until it looked exactly how I wanted it. " +
